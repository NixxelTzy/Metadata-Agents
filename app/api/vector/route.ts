  ...
  try {
    ...
    const { action, payload } = body as {
      ...
      payload: {
        prompt?: string;
        theme?: string;
        style?: string; // "flat" | "outline" | "both"
        ratio?: string; // "1:1" | "16:9" | "9:16" | "4:3" | "3:4" | "21:9"
        faceless?: boolean;
        consistency?: boolean;
        mode?: "prompt" | "noprompt"; // with prompt or autopilot
        colorPalette?: string;
        complexity?: "simple" | "medium" | "complex";
        targetUse?: string; // e.g. "business icon set", "landing page illustration", etc.
