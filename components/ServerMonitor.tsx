...
interface MonitorData {
  ...
  security: {
    stats: { total: number; bySeverity: Record<string, number>; byType: Record<string, number>; last24h: number };
    recentAttacks: { type: string; severity: string; ip: string; endpoint: string; timestamp: number; requestId: string }[];
      ...
      <div className="mon-body">
        ...
        {tab === "security" && (
          <>
            ...
            <div className="mon-section">
              <div className="mon-section__title">Security Events</div>
              <div className="mon-info-row"><span>Total</span><span>{data.security.stats.total}</span></div>
            ...
            <div className="mon-section">
              <div className="mon-section__title">By Type</div>
              {Object.entries(data.security.stats.byType).length === 0
                ? <div className="mon-empty">Tidak ada event</div>
                : Object.entries(data.security.stats.byType).map(([k, v]) => (
                  <div key={k} className="mon-info-row">
              ...
              : (
                <div className="mon-attack-list">
                  {data.security.recentAttacks.map((a) => (
                    <div key={a.requestId} className="mon-attack-item">
                      <div className="mon-attack-item__header">
